...
const StarContributor = ({ sectionId, pageId }) => {
  ...
  if (loading) {
    ...
    return (
      <div className="flex items-center justify-center px-2.5 py-1.5 bg-amber-100 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-800 rounded-lg h-[44px] w-[140px]">
        <svg className="animate-spin h-5 w-5 text-amber-700 dark:text-amber-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
