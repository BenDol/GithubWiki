...
const VideoGuideCard = ({
  ...
  return (
    <div className="video-guide-card group bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden">
      {/* Thumbnail */}
      <div className="relative w-full pb-[56.25%] bg-gray-200 dark:bg-gray-700 overflow-hidden">
        {thumbnailUrl ? (
          <img
            src={thumbnailUrl}
