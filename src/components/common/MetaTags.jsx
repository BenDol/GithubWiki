...
/**
 * MetaTags Component (Framework)
 *
 * Manages dynamic Open Graph, Twitter Card, and SEO meta tags
 *
 * @param {Object} props
...
const MetaTags = ({
  ...
  const siteTitle = wikiConfig.title || 'Wiki';
  const siteDescription = wikiConfig.description || 'Community-maintained wiki';
  const siteUrl = wikiConfig.url || '';
