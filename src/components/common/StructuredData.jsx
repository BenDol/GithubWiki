...
/**
 * StructuredData Component (Framework)
 *
 * Adds Schema.org JSON-LD markup to help search engines understand content
 *
 * @param {Object} props
 ...
 */
export const GameStructuredData = ({ name, description, url, image, genre, gamePlatform, publisher }) => {
  return (
    <StructuredData
      type="VideoGame"
      data={{
