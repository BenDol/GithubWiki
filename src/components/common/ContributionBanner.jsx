 ...
 * @param {string} props.customFooter - Custom footer override
 */
const ContributionBanner = ({
  ...
  const defaultMessages = {
    'ai-generated': {
      ...
      message: 'This page was generated by AI but it\'s ready for a human touch! Share your valuable insight and become a contributor to the wiki!',
